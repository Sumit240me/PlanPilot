...
const SavedCard = ({ img, name, location, id, fallbackImages , status}) => {
  ...
  return (
    <div ref={revealRef} className='flex flex-col shadow-md shadow-gray-200 rounded-4xl hover:shadow-lg hover:shadow-gray-300 transition-all cursor-pointer bg-white reveal-scale'>
      ...
      <div className='p-4'>
        ...
        <div className='text-xs font-semibold text-green-500 hover:text-green-700'>{status === "completed" ? <p onClick={() => navigate(`/review/${id}`)} >Rate Trip</p>: <p></p>}</div>
        </div>
      ...
      <div className='flex flex-row px-4 pb-4 gap-2 justify-between items-center'>
        ...
        <div className='text-red-500 cursor-pointer p-2 rounded-full hover:bg-red-100 hover:text-red-700 transition-all' onClick={() => deleteTrip(id)}>
